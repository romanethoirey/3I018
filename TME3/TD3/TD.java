...
public class TD {
	...
	if (getClassName(expr).equals("IntConst")) {
	...
	} else if (getClassName(expr).equals("BinOp")) { /*** Correction ***/
	    ...
	    System.out.print("?: ");
	    imprimerPrefixe(((TerOp)expr).getTest());
	    System.out.print(" ");
	    imprimerPrefixe(((TerOp)expr).getAltv());
	    System.out.print(" ");
	    imprimerPrefixe(((TerOp)expr).getAltf());
	}
    }
	...
	if (getClassName(expr).equals("IntConst")) {
	    ...
	    imprimerPostfixe(((TerOp)expr).getTest());
	    System.out.print(" ");
	    imprimerPostfixe(((TerOp)expr).getAltv());
	    System.out.print(" ");
	    imprimerPostfixe(((TerOp)expr).getAltf());
	    System.out.print(" ?:");
	}
    }
	...
	if (getClassName(expr).equals("IntConst")) {
	    ...
	    System.out.print(((EVar)expr).getName());
	} else if (getClassName(expr).equals("BinOp")) {
	    System.out.print("(");
	    ...
	    System.out.print("(");
	    imprimerInfixeParenthese(((TerOp)expr).getTest());
	    System.out.print(" ? ");
	    imprimerInfixeParenthese(((TerOp)expr).getAltv());
	    System.out.print(" : ");
	    imprimerInfixeParenthese(((TerOp)expr).getAltf());
	    System.out.print(")");
	}
    }
